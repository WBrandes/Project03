...
public class RightTurnMethod implements RoutingMethod {
	
	/*
	 * This uses the NormalMethod for turning; we didn't have enough time to implement this model
	 */
	...
	public RightTurnMethod(int truckFacingDirection, double startLocationX, double startLocationY) {
